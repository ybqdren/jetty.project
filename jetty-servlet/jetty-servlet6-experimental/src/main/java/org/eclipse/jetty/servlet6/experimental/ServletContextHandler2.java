...
public class ServletContextHandler2 extends TempContextHandler
{
    ...
    public static ServletContextHandler getServletContextHandler(ServletContext servletContext, String purpose)
    {
        if (servletContext instanceof ServletContextHandler.Context)
            return ((ServletContextHandler.Context)servletContext).getServletContextHandler();
    ...
    public static ServletContextHandler getServletContextHandler(ServletContext context)
    {
        if (context instanceof ServletContextHandler.Context)
            return ((ServletContextHandler.Context)context).getServletContextHandler();
        return null;
    }
...
//    protected Class<? extends SecurityHandler> _defaultSecurityHandlerClass = org.eclipse.jetty.security.ConstraintSecurityHandler.class;
    ...
    public ServletContextHandler2(int options)
    {
        this(null, null, options);
    }

    public ServletContextHandler2(Handler.Container parent, String contextPath)
    {
        this(parent, contextPath, null, null, null, null);
    }

    public ServletContextHandler2(Handler.Container parent, String contextPath, int options)
    {
        this(parent, contextPath, null, null, null, null, options);
    }

    public ServletContextHandler2(Handler.Container parent, String contextPath, boolean sessions, boolean security)
    {
        this(parent, contextPath, (sessions ? SESSIONS : 0) | (security ? SECURITY : 0));
    }

    public ServletContextHandler2(Handler.Container parent, SessionHandler sessionHandler, SecurityHandler securityHandler, ServletHandler servletHandler, ErrorHandler errorHandler)
    {
        this(parent, null, sessionHandler, securityHandler, servletHandler, errorHandler);
    }

    public ServletContextHandler2(Handler.Container parent, String contextPath, SessionHandler sessionHandler, SecurityHandler securityHandler, ServletHandler servletHandler, ErrorHandler errorHandler)
    {
