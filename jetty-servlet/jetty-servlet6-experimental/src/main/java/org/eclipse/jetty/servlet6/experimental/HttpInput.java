...
import org.eclipse.jetty.servlet6.experimental.ServletContextHandler.Context;
    ...
    public void run()
    {
        ...
        if (content.isSpecial())
        {
            ...
            if (error != null)
            {
                ...
                _channelState.getHttpChannel().getResponse().getHeaders().add(HttpConnection.CONNECTION_CLOSE);
