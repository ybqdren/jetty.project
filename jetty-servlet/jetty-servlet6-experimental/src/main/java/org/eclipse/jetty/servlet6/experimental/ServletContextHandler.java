...
//    protected Class<? extends SecurityHandler> _defaultSecurityHandlerClass = org.eclipse.jetty.security.ConstraintSecurityHandler.class;
    ...
    public ServletContextHandler(Handler.Container parent, String contextPath)
    {
        this(parent, contextPath, null, null, null, null);
    }

    public ServletContextHandler(Handler.Container parent, String contextPath, int options)
    {
    ...
    protected void invokeHandler(Request request, Response response) throws Exception
    {
        ...
        final boolean new_context = scopedRequest.takeNewContext();
        try
        {
    ...
    public class PartialContext extends StaticContext
    {
        ...
        public ServletContext getContext(String uripath)
        {
            ...
            List<ServletContextHandler> handlers = getServer().getChildHandlersByClass(ServletContextHandler.class);
        ...
        public Enumeration<String> getAttributeNames()
        {
            ...
            set.addAll(ServletContextHandler.this.getAttributeNames());
