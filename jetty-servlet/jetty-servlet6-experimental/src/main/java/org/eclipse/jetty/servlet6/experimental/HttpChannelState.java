...
public class HttpChannelState
{
    ...
    private final ServletRequestState _servletRequestState;
    ...
    protected HttpChannelState(ServletRequestState servletRequestState)
    {
        _channel = servletRequestState.getHttpChannel();
    ...
    private Action nextAction(boolean handling)
    {
        ...
        switch (_requestState)
        {
            ...
            case ASYNC:
                ...
                Scheduler scheduler = _servletRequestState.getServletScopedRequest()
    ...
    public void complete()
    {
        ...
        cancelTimeout(event);
        if (handle)
            runInContext(event, _servletRequestState);
    }
    ...
    private void sendError(Throwable th)
    {
        ...
        Throwable cause = _servletRequestState.unwrap(th, BadMessageException.class, UnavailableException.class);
        if (cause == null)
        {
    ...
    public void sendError(int code, String message)
    {
        ...
        ServletScopedRequest servletScopedRequest = _servletRequestState.getServletScopedRequest();
    ...
    protected void completed(Throwable failure)
    {
        ...
        _servletRequestState.getHttpOutput().completed(failure);
    ...
    {
        _servletRequestState.getContext().run(runnable);
    }
