 ...
 */
public abstract class ServletChannel2 implements Runnable, HttpOutput.Interceptor
{
    ...
    private final ServletScopedResponse _response;
    ...
    public ServletChannel2(Connector connector, HttpConfiguration configuration, EndPoint endPoint, HttpTransport transport)
    {
    ...
    public boolean handle()
    {
        ...
        ServletRequestState.Action action = _state.handling();
    ...
    private class SendCallback extends Callback.Nested
    {
        ...
        public void failed(final Throwable x)
        {
            ...
            {
                _transport.send(_request.getMetaData(), HttpGenerator.RESPONSE_500_INFO, null, true, new Nested(this)
                {
                    @Override
                    public void succeeded()
                    {
