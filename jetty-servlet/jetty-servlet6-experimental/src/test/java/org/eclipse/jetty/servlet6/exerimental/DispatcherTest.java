...
import org.eclipse.jetty.servlet6.experimental.Dispatcher;
import org.eclipse.jetty.servlet6.experimental.ServletContextHandler;
import org.eclipse.jetty.servlet6.experimental.ServletHolder;
...
public class DispatcherTest
{
    ...
    private ServletContextHandler _resourceHandler;
    ...
    public void init() throws Exception
    {
        ...
        _resourceHandler = new ServletContextHandler();
        _resourceHandler.setResourceBase(MavenTestingUtils.getTestResourceDir("dispatchResourceTest").toPath().toAbsolutePath());
