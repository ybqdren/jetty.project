...
{    
    ...
    public SessionInactivityTimer(SessionHandler sessionHandler, Session session, Scheduler scheduler)
    {
            ...
            public void onTimeoutExpired()
            {
                ...
                try (AutoLock lock = _session.lock())
                {
                    ...
                    if (_session.isExpiredAt(now))
                        SessionInactivityTimer.this._sessionHandler.sessionExpired(_session, now);
